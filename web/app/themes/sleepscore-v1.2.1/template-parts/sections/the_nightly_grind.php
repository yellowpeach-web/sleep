...
$bg             = 'background: none';
$sectionclass[] = 'nightly_grind_sec';
...
<section <?php echo ! empty( $custom_id ) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" data-parallax style="<?php echo $bg; ?>">
        <div class="main">
            <div class="nightly_grind_content">
                <?php 
                    global $post;
                ...
                <?php if (isset($button_title) && !empty($button_title)): ?>
                    <a href="<?php echo $linkdata['url']; ?>" target="<?php echo $linkdata['target']; ?>" title="<?php echo seotitletag($button_title); ?>"><?php echo $button_title; ?></a>
                <?php endif; ?>
            </div>
        </div>
</section>