...
<div class="row">
	...
	<div class="<?php the_sub_field('product_title_classes'); ?>">
		<?php the_sub_field('product_title'); ?>
	</div>
	<?php endif; ?>
	<?php if(have_rows('shopify_product_repeater')): ?>

	<?php while(have_rows('shopify_product_repeater')): the_row(); ?>
		<?php $PRODUCT_ID =	get_sub_field('shopify_product_post_id'); ?>
		...
		?>			
		<a class="product-link <?php the_sub_field('shopify_product_classes'); ?>" href="<?php echo $prodLink; ?>">
